public class MaquinaExpendedoraSimple {
    ...
    /**
     * Devuelve el dinero que sobra del billete 
     */
    public int getTotalDineroAcumuladoe() {
     ...
     * Devuelve el precio del billete
     */
    public void setPrecioDelBillete(int cantidadIntroducida) {
        precioBillete = cantidadIntroducida;
    }
    
    /**
     * Nos cambia el precio del billete que habiamos quitado anteriormente
     */
    public void reducirPrecioDelBillete(int cantidadIntroducida) {
